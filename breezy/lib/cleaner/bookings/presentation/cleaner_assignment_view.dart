...
class _CleanerAssignmentViewState extends State<CleanerAssignmentView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: const AppBarWidget(title: 'Cleaning Request'),
      body: SafeArea(
        child: Padding(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: ListTile(
                      ...
                      title: Text('Sofia Vargas', style: textTheme.bodyMedium),
                      subtitle: Text(
                        'Deep cleaning',
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: colorTheme.surfaceContainerHigh),
                  ),
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: const [
